...
export default function ClassesSections() {
  ...
  <div className="flex flex-col md:flex-row gap-2 w-full md:w-auto">
    ...
    <Link to="/add-class">
      <button className="bg-blue-700 text-white px-4 py-2 rounded-lg w-full md:w-auto">
        + Add Class
      </button>
    </Link>
      ...
      {/* Table (Desktop) */}
      <div className="hidden md:block bg-white rounded shadow overflow-x-auto" style={{borderRadius:"10px"}}>
